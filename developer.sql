...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`idurl`)
) ENGINE=InnoDB AUTO_INCREMENT=74 DEFAULT CHARSET=utf8 COMMENT='URL links .';
...
-- Dump completed on 2018-05-09 16:35:23
