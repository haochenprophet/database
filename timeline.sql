CREATE DATABASE  IF NOT EXISTS `timeline` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `timeline`;
...
CREATE TABLE `timeline` (
  ...
  `how` varchar(200) DEFAULT NULL,
  `priority` int(11) DEFAULT NULL,
  `status` varchar(45) DEFAULT NULL,
  `remark` varchar(300) DEFAULT NULL,
  PRIMARY KEY (`idtimeline`,`uuid`,`time`),
  UNIQUE KEY `idtimeline_UNIQUE` (`idtimeline`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='object-timeline';
...
-- Dump completed on 2019-06-18 11:48:10
