...
CREATE TABLE `class` (
  ...
  `namespace` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  `template` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  `name` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  `base_list` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  ` member_list` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  `declarators` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  `url` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  `time` datetime DEFAULT CURRENT_TIMESTAMP,
  `status` varchar(45) CHARACTER SET utf8 COLLATE utf8_danish_ci DEFAULT NULL,
  `remark` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  PRIMARY KEY (`idclass`),
...
CREATE TABLE `token` (
  ...
  `token_type` varchar(45) CHARACTER SET utf8 COLLATE utf8_danish_ci NOT NULL COMMENT 'token_type',
  `lang_type` varchar(45) CHARACTER SET utf8 COLLATE utf8_danish_ci DEFAULT NULL COMMENT 'c/c++ php python java ....',
  `class` varchar(45) CHARACTER SET utf8 COLLATE utf8_danish_ci DEFAULT NULL,
  `time` datetime DEFAULT CURRENT_TIMESTAMP,
  `remark` text CHARACTER SET utf8 COLLATE utf8_danish_ci,
  PRIMARY KEY (`idtoken`),
...
-- Dump completed on 2019-08-10 15:22:46
