...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`idurl`)
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COMMENT='URL links .';
...
-- Dump completed on 2019-09-24 18:57:08
