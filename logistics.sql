...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`idurl`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='logistics URL links .';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-24 19:32:09
