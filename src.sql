...
CREATE TABLE `url` (
  ...
  PRIMARY KEY (`idurl`)
) ENGINE=InnoDB AUTO_INCREMENT=48 DEFAULT CHARSET=utf8 COMMENT='URL links .';
...
-- Dump completed on 2018-03-19 17:38:27
