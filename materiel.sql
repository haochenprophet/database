...
CREATE TABLE `materiel` (
  ...
  `where` varchar(45) NOT NULL COMMENT 'location',
  `what` varchar(45) DEFAULT NULL COMMENT 'what project',
  PRIMARY KEY (`idmateriel`,`uuid`,`time`,`type`,`barcode`,`serial_number`,`part_number`,`name`),
...
-- Dump completed on 2019-06-21 11:12:08
