CREATE DATABASE  IF NOT EXISTS `text` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `text`;
...
INSERT INTO `status` VALUES (1,'check in','2019-11-02 13:04:10');
...
CREATE TABLE `text` (
  ...
  `where` varchar(200) NOT NULL DEFAULT 'Red-Arrow ITC',
  `language` varchar(45) NOT NULL DEFAULT 'EN',
  PRIMARY KEY (`idtext`,`uuid`,`time`),
  UNIQUE KEY `idtext_UNIQUE` (`idtext`),
...
INSERT INTO `type` VALUES (6,'text','2019-11-02 12:39:16');
...
-- Dump completed on 2019-11-03 13:03:41
